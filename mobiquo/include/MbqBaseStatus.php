...
abstract class MbqBaseStatus
{
    ...
    abstract protected function ResetBYOInfo();
    ...
    public function TestPluginVersion()
    {
        ...
        $lastVersion = '';
        if($versions = file_get_contents('https://tapatalk.com/version.json'))
        {
            $versions = json_decode($versions);
            $lastPluginInfo = $versions->stable->$pluginName;
            $downloadUrl = 'https://www.tapatalk.com' . $lastPluginInfo->download_url;
            $lastVersion = $lastPluginInfo->version_string;
            return array('pluginName' =>  $pluginName, 'installedVersion' => $pluginVersion, 'lastVersion' => $lastVersion, 'downloadUrl' => $downloadUrl);
        }
        else
        {
            return array('pluginName' =>  $pluginName, 'installedVersion' => $pluginVersion, 'lastVersionError' => 'Cannot connect to Tapatalk server to get last version info');
        }
    }
    ...
    public function TestFilePermission()
    {
        ...
        $result['canWriteMobiquo'] = is_writable($mobiquoDirectory);
    ...
    public function TestBYOInfo()
    {
        ...
        $result['fileRedirct'] = isset($byoInfo['file_redirct']) ? $byoInfo['file_redirct'] : 'N/A';
        $result['imageRedirct'] = isset($byoInfo['image_redirct']) ? $byoInfo['image_redirct'] : 'N/A';
        return $result;
    }
    ...
    <div class="container theme-showcase" role="main" style="margin-top:80px">
                    ...
                    <div class="panel panel-default" id="panelBYO">
                        ...
                        <div class="panel-body">
                           ...
                           Tapatalk file redirect:
                            <span id="fileRedirct">Loading...</span>
                            <br />
                            Tapatalk image redirect:
                            <span id="imageRedirct">Loading...</span>
                            <br />
                        </div>
                    </div>
            ...
            <div class="col-sm-6">
                    ...
                    <div class="panel panel-default" id="panelFilePermissions">
                        ...
                        <div class="panel-body">
                            ...
                            <br />
                            Can write in plugin directory:
                            <span id="filePermissionsCanWrite">Loading...</span>
                            <br />
        ...
        <script language="javascript">
            ...
            function TestFilePermission() {
                ...
                SetSpan('filePermissionsCanWrite', 'black', 'Loading...');
                ...
                .done(function (data) {
                    ...
                    if (result.canWriteMobiquo) {
                        SetSpan('filePermissionsCanWrite', 'green', 'Yes');
                    }
                    else {
                        SetSpan('filePermissionsCanWrite', 'orange', 'No');
                        resultFilePermission = SetTestResult(resultFilePermission, 0);
                    }
            ...
            function TestBYOInfo() {
                ...
                SetSpan('fileRedirct', 'black', 'Loading...');
                SetSpan('imageRedirct', 'black', 'Loading...');
                ...
                .done(function (data) {
                    ...
                    SetSpan('byoAppAlertMessage', 'black', result.byoAppAlertMessage);
                     SetSpan('fileRedirct', 'black', result.fileRedirct);
                    SetSpan('imageRedirct', 'black', result.imageRedirct);
