 ...
 *
 * @package	vBulletin
 * @version	$Revision: 30388 $
 * @date		$Date: 2009-04-21 08:51:43 -0500 (Tue, 21 Apr 2009) $
 */
class vB_Upload_Abstract
{
	...
	function accept_upload(&$upload)
	{
		...
		else
		{
			...
			else if ($this->upload['error'] OR $this->upload['location'] == 'none' OR $this->upload['location'] == '' OR $this->upload['filename'] == '' OR !$this->upload['filesize'])
			{
