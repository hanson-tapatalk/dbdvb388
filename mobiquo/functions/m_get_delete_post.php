    ...
    if ($totalposts)
    {
        ...
        while ($post = $db->fetch_array($posts))
        {
            ...
            $return_post = new xmlrpcval(array(
                ...
                'post_time'             => new xmlrpcval(mobiquo_time_encode( $post['postdateline']), 'dateTime.iso8601'),
                'timestamp'             => new xmlrpcval($post['postdateline'], 'string'),
                ...
                'deleted_by_id'     => new xmlrpcval($post['del_userid'], 'string'),
