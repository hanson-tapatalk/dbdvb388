...
$app_redirect_link = isset($_GET['deeplink']) ? "tapatalk://".$deeplink : preg_replace('#^https?://#is', 'tapatalk://', $deeplink);
...
$image_list = array(
    ...
    'close.png', 'logo.png',
    'tapatalk-banner-logo.png', 'star.png', 'full_view_add_v3_logo.png',
    'full_view_add_v3_mobile.png', 'full_view_add_v3_line.png'
);
...
<link rel="stylesheet" type="text/css" href="https://welcome-screen.tapatalk-cdn.com/welcome_screen_v3.css"/>
<!-- <link rel="stylesheet" type="text/css" href="https://welcome-screen.s3.amazonaws.com/welcome_screen_v3.css"/> -->
...
<script type="text/javascript" src="https://welcome-screen.tapatalk-cdn.com/welcome3.js" charset="UTF-8"></script>
<!-- <script type="text/javascript" src="https://welcome-screen.s3.amazonaws.com/welcome3.js" charset="UTF-8"></script> -->
<script>
    $(document).ready(function()
    {
        ...
        // {
        //     $("#button1 a").attr("href", '<?php echo addslashes(htmlspecialchars($app_redirect_link , ENT_QUOTES, "UTF-8"))?>');
        // }else{
        //     $("#button1 a").click(function(){
        //         setTimeout(function (){ window.location = '<?php echo addslashes(htmlspecialchars($app_redirect_link , ENT_QUOTES, "UTF-8"))?>';}, 0);
        //         setTimeout(function (){ window.location = 'http://tapstream.tapatalk.com/lzzq-1/?__tsid=$TSID&__tsid_override=1&referer='+encodeURIComponent(app_deep_link);}, 500);
        //      });
        // }
        $("#button1 a").attr("href", '<?php echo addslashes(htmlspecialchars($app_redirect_link , ENT_QUOTES, "UTF-8"))?>');
        $("#button2 a").attr("href", 'http://tapstream.tapatalk.com/lzzq-1/?__tsid=$TSID&__tsid_override=1&referer='+encodeURIComponent(app_deep_link));
        $("#button3 a").attr("href", '<?php echo addslashes(htmlspecialchars($redirect_url, ENT_QUOTES, "UTF-8"))?>');
    })
</script>
</head>
<body scroll="no">
