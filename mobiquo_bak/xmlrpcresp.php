    ...
    foreach ($search_result['items'] as $item)
    {
        ...
        if($search_result['showposts'])
        {
            $return_post = array(
                ...
                'user_type'             => new xmlrpcval(get_usertype_by_item($item['userid']), 'base64'),
        ...
        else
        {
            ...
            $return_thread = array(
                ...
                'user_type'             => new xmlrpcval(get_usertype_by_item($item['postuserid']), 'base64'),
              ...
              'last_reply_author_name'  => new xmlrpcval(mobiquo_encode($item['lastposter']), 'base64'),
                ...
                'short_content'         => new xmlrpcval(mobiquo_encode(mobiquo_chop(post_content_clean($item['preview']))), 'base64'),
