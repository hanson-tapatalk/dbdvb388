    ...
    $.cchangout = (function(){
        ...
        return {
            ...
            initialize: function(){
                ...
                if(settings.showModules==1){
                    ...
                    for(x in trayicon){
                        if(trayicon.hasOwnProperty(x)){
                            ...
                            trayData += '<span id="cometchat_trayicon_'+x+'" class="cometchat_trayiconimage cometchat_tooltip" data-title="'+trayicon[x][1]+'" '+onclick+'><img class="'+x+'icon" src="'+baseUrl+'themes/'+settings.theme+'/images/modules/'+x+'.png" onerror="jqcc.'+settings.theme+'.iconNotFound(this,\''+icon[0]+'\')"></span>';
                        }                        
                    }
                    trayData += '</div>';
                }
                ...
                if(jqcc().slimScroll){
                    $('#cometchat_userscontent').slimScroll({height: $('#cometchat_userscontent').outerHeight()});
                }
            ...
            userStatus: function(item){
                ...
                if(item.s=='offline'){
                    ...
                    $("div.cometchat_userstabtitle").attr('class','cometchat_userstabtitle cometchat_userstabtitle_'+item.s);
                }
                if(item.id>10000000){
                    $("#guestsname").show();
            ...
            createChatboxData: function(id, name, status, message, avatar, link, silent, tryOldMessages){
                ...
                $('#cometchat_chatboxes_wide').width($('#cometchat_chatboxes_wide').width()+230+5);
                jqcc[settings.theme].windowResize(1);
                shortname = name;
                longname = name;
                $("<span/>").attr("id", "cometchat_user_"+id).attr("amount", 0).addClass("cometchat_tab").html('<div class="cometchat_icon"></div><div class="cometchat_user_shortname">'+shortname+'</div><div class="cometchat_closebox_bottom cometchat_tooltip" id="cometchat_closebox_bottom_'+id+'" data-title="'+language[74]+'"></div>').appendTo($("#cometchat_chatboxes_wide"));
                var pluginshtml = '';
                var smiliehtml = '';
                        ...
                        for(var i = 0; i<pluginslength; i++){
                            ...
                            if(typeof ($[name])=='object'){
                                if(settings.plugins[i]!='chattime'&&settings.plugins[i]!='smilies'){
                                    ...
                                    pluginshtml += '<div id="cometchat_'+settings.plugins[i]+'_'+id+'" class="cometchat_pluginsicon cometchat_'+settings.plugins[i]+' cometchat_tooltip" onclick="javascript:jqcc.'+name+'.init('+id+');" data-title="'+$[name].getTitle()+'" '+extraStyle+'></div>';
                                } else if(settings.plugins[i]=='smilies') {
                                    smiliehtml = '<div class="cometchat_pluginsicon cometchat_smilies" style="margin-top:5px;" onclick="javascript:jqcc.ccsmilies.init('+id+');"></div>';
                                }
                            }
                        }
                        pluginshtml += '</div>';
                ...
                cometchat_user_id.click(function(){
                    if($(this).hasClass('cometchat_tabclick')){
                        ...
                        if((cometchat_user_id.offset().left<(cometchat_chatboxes.offset().left+cometchat_chatboxes.width()))&&(cometchat_user_id.offset().left-cometchat_chatboxes.offset().left)>=0){
                            $("#cometchat_user_"+id+'_popup').css('left', baseLeft+cometchat_user_id.position().left-((chatboxWidth)-230-1));
                            ...
                            var newPosition = ((cometchat_user_id.offset().left-$("#cometchat_chatboxes_wide").offset().left))-((Math.floor((cometchat_chatboxes.width()/230))-6)*230+5);
                ...
                cometchat_closebox_bottom.click(function(){
                    ...
                    $('#cometchat_chatboxes_wide').width($('#cometchat_chatboxes_wide').width()-230-5);
                    cometchat_chatboxes.scrollToCC("-=230px");
                    jqcc[settings.theme].windowResize();
                ...
                if(jqcc().slimScroll){
                    cometchat_tabcontenttext.slimScroll({height: ((chatboxHeight+10))+'px'});
                }
                chatbottom[id] = 1;
                ...
                cometchat_tabtitle.append('<div class="cometchat_closebox cometchat_tooltip" id="cometchat_closebox_'+id+'" data-title="'+language[74]+'"></div><div class="cometchat_minimizebox cometchat_tooltip" id="cometchat_minimizebox_'+id+'" data-title="'+language[75]+'"></div><br clear="all"/>');
            ...
            addMessages: function(item){
                $.each(item, function(i, incoming){
                    ...
                    if(chatboxOpened[incoming.from]!=1&&incoming.old!=1){
                        ...
                        if(jqcc.cometchat.getThemeArray('buddylistName', incoming.from)==null||jqcc.cometchat.getThemeArray('buddylistName', incoming.from)==''){
                            ...
                            if($("#cometchat_message_"+incoming.id).length>0){
                                $("#cometchat_message_"+incoming.id).html(processedmessage);
                            }else{
                                sentdata = '';
                                    ...
                                    if(cometchat_tabcontenttext_incomingfrom.find(".cometchat_chatboxmessage:last").hasClass('self')){
                                        if($("#cometchat_message_"+incoming.id)>0){
                                            ...
                                            if(cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last.self div.cometchat_chatboxmessagecontent').hasClass('cometchat_self_content')){
                                                cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last.self .cometchat_self_content span.cometchat_ts').before('<div id="cometchat_message_'+incoming.id+'" class="'+selfstyle+'">'+processedmessage+'</div>');
                                            }
                                        }
                                    ...
                                    if(cometchat_tabcontenttext_incomingfrom.find('div.cometchat_chatboxmessage:last').hasClass('other')){
                                        if($("#cometchat_message_"+incoming.id)>0){
                                            ...
                                            if(cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last.other div.cometchat_chatboxmessagecontent  ').hasClass('cometchat_other_content')){
                                                cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last .cometchat_other_content .cometchat_message_name').before('<div id="cometchat_message_'+incoming.id+'" class="'+selfstyle+' cometchat_other_noarrow">'+processedmessage+'</div>');
                                            }
                                        }
                    ...
                    if(newMessage>0){
                        if(cometchat_tabcontenttext_incomingfrom.outerHeight()<totalHeight){
            ...
            optionsButton: function(){
                ...
                cometchat_optionsbutton_popup.find("span.available").click(function(event){
                    if(jqcc.cometchat.getThemeArray('buddylistStatus', jqcc.cometchat.getThemeVariable('userid'))!='available'){
                        jqcc.cometchat.setThemeArray('buddylistStatus', jqcc.cometchat.getThemeVariable('userid'), 'available');
                        jqcc[settings.theme].removeUnderline();
                        $(".cometchat_userstabtitle").attr('class','cometchat_userstabtitle cometchat_userstabtitle_available');
                        $("#cometchat_userstab_icon").addClass('cometchat_user_available2');
                ...
                cometchat_optionsbutton_popup.find("span.busy").click(function(event){
                    if(jqcc.cometchat.getThemeArray('buddylistStatus', jqcc.cometchat.getThemeVariable('userid'))!='busy'){
                        ...
                        jqcc[settings.theme].removeUnderline();
                        $("div.cometchat_userstabtitle").attr('class','cometchat_userstabtitle cometchat_userstabtitle_busy');
                ...
                cometchat_optionsbutton.mouseover(function(){
                    if(!cometchat_optionsbutton_popup.hasClass("cometchat_tabopen")){
                        if(jqcc.cometchat.getThemeVariable('loggedout')==0){
                            ...
                            if(tooltipPriority==0){
                                jqcc[settings.theme].tooltip('cometchat_optionsbutton_icon', language[8]);
                            }
                        }
                    }
                    $(this).addClass("cometchat_tabmouseover");
            ...
            scrollBars: function(silent){
                ...
                if(cometchat_chatboxes.scrollLeft()==0){
                    ...
                    var number = Math.floor(cometchat_chatboxes.scrollLeft()/230);
                ...
                if((cometchat_chatboxes.scrollLeft()+cometchat_chatboxes.width())==$("#cometchat_chatboxes_wide").width()){
                    ...
                    var number = Math.floor(($("#cometchat_chatboxes_wide").width()-(cometchat_chatboxes.scrollLeft()+cometchat_chatboxes.width()))/230);
            ...
            windowResize: function(silent){
                ...
                if($('#cometchat_chatboxes_wide').width()<=($(window).width()-26-178-44-extraWidth)){
                    ...
                    var correction = ((Math.floor(change/230))*5);
                    cometchat_chatboxes.css('width', Math.floor(($(window).width()-26-178-44-extraWidth)/230)*230+correction);
                    var newChange = cometchat_chatboxes.width();
                    if(change!=newChange){
                        cometchat_chatboxes.scrollToCC("-=230px", 0);
                    }
                }
                ...
                $.each(chatboxOpened, function(openChatboxId, state){
                    if(state==1&&silent!=1&&$("#cometchat_user_"+openChatboxId).length>0){
                        ...
                        if((cometchat_user_openChatboxId.offset().left<(cometchat_chatboxes.offset().left+cometchat_chatboxes.width()))&&(cometchat_user_openChatboxId.offset().left-cometchat_chatboxes.offset().left)>=0){
                            var left = baseLeft+cometchat_user_openChatboxId.offset().left-((chatboxWidth)-230+20);
