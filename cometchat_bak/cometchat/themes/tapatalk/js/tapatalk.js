    ...
    $.cctapatalk = (function(){
        ...
        return {
            ...
            loggedOut: function(){
                ...
                $("#loggedout").show();
                $("#cometchat_optionsbutton, #cometchat_userstab, #cometchat_chatboxes, #cometchat_chatbox_left, #cometchat_chatbox_right","#cometchat_sidebar").hide();

                $("#cometchat_sidebar").css('display','none');
                $("#cometchat_userstab").css('display','none');
                $("#cometchat_chatboxes").css('display','none');
                $("#cometchat_chatbox_left").css('display','none');
                $("#cometchat_chatbox_right").css('display','none');
            ...
            chatWith: function(id){
                ...
                if(jqcc.cometchat.getThemeVariable('loggedout')==0){
                    ...
                    if( name != 'undefined' && add)
                    {
                        ...
                        if($('#cometchat_userslist').hasClass('.cometchat_nofriends')){
