...
*
* @package 		vBulletin
* @version		$Revision: 93382 $
* @date 		$Date: 2017-03-15 19:31:14 -0700 (Wed, 15 Mar 2017) $
*
*/
class vB_HumanVerify_Question extends vB_HumanVerify_Abstract
{
	...
	*/
	...
	function output_token($var_prefix = 'humanverify')
	{
		...
		$humanverify['question'] = htmlspecialchars_uni(fetch_phrase('question' . $humanverify['answer'], 'hvquestion', '', false, true, $this->registry->userinfo['languageid'], false));
