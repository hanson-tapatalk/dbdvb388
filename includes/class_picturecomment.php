...
class vB_Picture_CommentFactory
{
	...
	*/
	function __construct(&$registry, &$bbcode, &$pictureinfo)
	{
...
class vB_Picture_Comment
{
	...
	*/
	function __construct(&$registry, &$factory, &$bbcode, $pictureinfo, $message)
	{
	...
	*/
	function prepare_end()
	{
		...
		{
			$this->message['messageipaddress'] = ($this->message['messageipaddress'] ? $this->message['messageipaddress'] : '');
		}
		else
		{
