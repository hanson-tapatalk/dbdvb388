	...
	do
	{
		...
		$messages = $vbulletin->db->query_read("
			SELECT SQL_CALC_FOUND_ROWS
				picturecomment.*, user.*, ipaddress.ip AS messageipaddress, ipaddress.ip AS ipaddress
			...
			LEFT JOIN " . TABLE_PREFIX . "ipaddress AS ipaddress ON (ipaddress.ipid = picturecomment.ipaddress)
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 03:31, Fri Jun 16th 2017 : $Revision: 93109 $
|| # $Date: 2017-02-24 15:09:54 -0800 (Fri, 24 Feb 2017) $
|| ####################################################################
\*======================================================================*/
?>
