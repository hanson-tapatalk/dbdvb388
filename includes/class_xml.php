...
* @version		$Revision: 94040 $
* @date 		$Date: 2017-05-15 16:34:36 -0700 (Mon, 15 May 2017) $
...
class vB_XML_Parser
{
	...
	*/
	function &parse($encoding = 'ISO-8859-1', $emptydata = true)
	{
		...
		{
			$this->error_code = XML_ERROR_NO_ELEMENTS + 0;
			return false;
		}
	...
	*/
	function parse_xml()
	{
		...
		if (preg_match('#(<?xml.*encoding=[\'"])(.*?)([\'"].*?>)#m', $this->xmldata, $match))
		{
			...
			if ($in_encoding != 'UTF-8' OR strtoupper($stylevar['charset']) != 'UTF-8')
			{
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 03:31, Fri Jun 16th 2017 : $Revision: 94040 $
|| # $Date: 2017-05-15 16:34:36 -0700 (Mon, 15 May 2017) $
|| ####################################################################
\*======================================================================*/
