...
class vB_Bitfield_Builder
{
	...
	*/
	public static function &init()
	{
		if (!self::$instance)
		{
			//TODO: this does not play well with opcache
			require_once(DIR . '/includes/class_xml.php');
			self::$instance = new vB_Bitfield_Builder();
		}
	...
	*/
	public static function build_datastore()
	{
		$obj = vB_Bitfield_Builder::init();
	...
	* @return	boolean
	*/
	public static function save($dbobject)
	{
		$obj = vB_Bitfield_Builder::init();
