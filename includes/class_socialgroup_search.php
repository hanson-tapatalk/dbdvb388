...
/*======================================================================*\
|| #################################################################### ||
|| # vBulletin Project Tools 3.8.11 - Licence Number VBF83FEF44
|| # ---------------------------------------------------------------- # ||
...
class vB_SGSearchGenerator
{
	...
	*/
	public static function prepare_search_text($query_text, &$errors)
	{
		global $vbulletin;
	...
	*/
	function add_text($name, $value)
	{
		...
		$value = self::prepare_search_text($value, $errors);
		if ($errors)
		{
