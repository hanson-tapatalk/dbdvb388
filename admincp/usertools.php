...
if ($_REQUEST['do'] == 'profilepic')
{
	...
	print_input_row($vbphrase['enter_image_url'], 'profilepicurl', '');
...
if ($_REQUEST['do'] == 'sigpic')
{
	...
	print_input_row($vbphrase['enter_image_url'], 'sigpicurl', '');
	print_upload_row($vbphrase['upload_image_from_computer'], 'upload');
...
if ($_REQUEST['do'] == 'avatar')
{
	...
	print_input_row($vbphrase['enter_image_url'], 'avatarurl', '');
	print_upload_row($vbphrase['upload_image_from_computer'], 'upload');
	construct_hidden_code('userid', $vbulletin->GPC['userid']);
	print_submit_row($vbphrase['save']);
}
...
if ($_REQUEST['do'] == 'pmfolderstats')
{
	...
	$foldernames = vb_unserialize($user['pmfolders']);
