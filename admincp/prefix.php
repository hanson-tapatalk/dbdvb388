...
if ($_POST['do'] == 'savepermissions')
{
	...
	$prefixids_raw = vb_unserialize(verify_client_string($vbulletin->GPC['prefixids']));
	...
	$shownusergroups_raw = vb_unserialize(verify_client_string($vbulletin->GPC['shownusergroups']));
