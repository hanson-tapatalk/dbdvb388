...
if ($_REQUEST['do'] == 'searchtype')
{
	...
	$allow_innodb = (version_compare(MYSQL_VERSION, '5.6.0', '>=')) ? true : false;
	$warning2 = iif((!$allow_innodb AND ($convertpost OR $convertthread)), $vbphrase['your_post_and_thread_table_will_be_converted']);
